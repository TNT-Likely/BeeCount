...
Future<({int inserted})> importTransactionsJson(
  ...
  // v31:manual import 路径(recordChanges=true)需要传 changeTracker,让
  // budgets 恢复也能按 payload syncId 记 change,与 tx 记 change 保持一致。
  // fullPull 传 null(recordChanges=false)即可。
