...
class CategoryUtils {
  ...
  static String _translateCategoryKey(
      String key, String kind, AppLocalizations l10n) {
    // 获取对应的翻译字符串
  ...
  static String _getExpenseSubcategoryTranslation(
      String parentKey, AppLocalizations l10n) {
    switch (parentKey) {
      case 'dining':
  ...
  /// 获取收入类二级分类的翻译字符串
  static String _getIncomeSubcategoryTranslation(
      String parentKey, AppLocalizations l10n) {
    switch (parentKey) {
      case 'salary':
        return l10n.categoryIncomeSalary;
      case 'investment':
        return l10n.categoryIncomeInvestment;
      case 'red_packet':
        return l10n.categoryIncomeRedPacket;
      case 'bonus':
        return l10n.categoryIncomeBonus;
      case 'reimbursement':
        return l10n.categoryIncomeReimbursement;
      case 'part_time':
        return l10n.categoryIncomePartTime;
      case 'gift':
        return l10n.categoryIncomeGift;
      case 'interest':
        return l10n.categoryIncomeInterest;
      case 'refund':
        return l10n.categoryIncomeRefund;
      case 'invest_income':
        return l10n.categoryIncomeInvestIncome;
      case 'second_hand':
        return l10n.categoryIncomeSecondHand;
      case 'social_benefit':
        return l10n.categoryIncomeSocialBenefit;
      case 'tax_refund':
        return l10n.categoryIncomeTaxRefund;
      case 'provident_fund':
        return l10n.categoryIncomeProvidentFund;
      default:
        return '';
    }
  }
  ...
  static String _parseCategoryName(
      String key, String kind, String translationString) {
  ...
  static List<String> getSubcategoryDisplayNames(
      String parentKey, String kind, AppLocalizations l10n) {
    final translationString =
        _getCategoryTranslationString('${parentKey}_', kind, l10n);
