                      ...
                      child: ElevatedButton(
                        onPressed: () async {
                          ...
                          await notificationUtil.showNotification(
                            id: 9999,
                            title:
                                AppLocalizations.of(context)!.reminderTestTitle,
                            body:
                                AppLocalizations.of(context)!.reminderTestBody,
                          );
                          if (context.mounted) {
                            showToast(context,
                                      ...
                                      Text(AppLocalizations.of(context)!
                                          .reminderManufacturer(
                                              batteryInfo['manufacturer'] ??
                                                  'Unknown')),
                                      Text(AppLocalizations.of(context)!
                                          .reminderModel(batteryInfo['model'] ??
                                              'Unknown')),
                                      Text(AppLocalizations.of(context)!
